...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "GlutenGo — Travel gluten-free without the stress" },
      { property: "og:description", content: "AI travel tools for people with celiac disease and gluten intolerance." },
