      ...
      <div style={{ padding: "16px 16px 80px" }}>
        <div style={{ background: "#fff7ed", borderRadius: 12, border: "1px solid #fdba74", padding: "10px 12px", marginBottom: 12 }}>
          <p style={{ margin: 0, fontSize: 12, color: "#9a3412", lineHeight: 1.5 }}>
            This analyzer is educational support only. Ingredient labels, regional naming, and manufacturing cross-contamination can change. Always verify with the brand/manufacturer.
          </p>
        </div>
        {/* Input */}
