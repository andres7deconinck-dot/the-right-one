...
const en: Translations = {
  ...
  hero: {
    ...
    subtitle: "AI-powered travel tools for people with celiac disease and gluten intolerance. Translation cards, safe restaurants, country guides — in your pocket.",
  ...
  features: {
    ...
    subtitle: "Six tools that replace a dozen apps, sticky notes and panic-Googling at the table.",
    items: [
      ...
      { title: "Travel Mode", text: "One tap → fullscreen card for staff. Cross-contamination, severity, thank you." },
...
const nl: Translations = {
  ...
  hero: {
    ...
    subtitle: "AI-gestuurde reistools voor mensen met coeliakie en glutenintolerantie. Vertaalkaarten, veilige restaurants, landengidsen — altijd bij de hand.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Reismodus", text: "Één tik → volledig scherm kaart voor personeel. Kruisbesmetting, ernst, dankjewel." },
...
const fr: Translations = {
  ...
  hero: {
    ...
    subtitle: "Outils de voyage IA pour les personnes atteintes de la maladie cœliaque et d'intolérance au gluten. Cartes de traduction, restaurants sûrs, guides par pays — dans votre poche.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Mode voyage", text: "Un tap → carte plein écran pour le personnel. Contamination croisée, gravité, merci." },
...
const de: Translations = {
  ...
  hero: {
    ...
    subtitle: "KI-gestützte Reisetools für Menschen mit Zöliakie und Glutenunverträglichkeit. Übersetzungskarten, sichere Restaurants, Länderführer — immer dabei.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Reisemodus", text: "Ein Tap → Vollbildkarte für das Personal. Kreuzkontamination, Schweregrad, Danke." },
...
const es: Translations = {
  ...
  hero: {
    ...
    subtitle: "Herramientas de viaje con IA para personas con enfermedad celíaca e intolerancia al gluten. Tarjetas de traducción, restaurantes seguros, guías por país — en tu bolsillo.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Modo viaje", text: "Un tap → tarjeta en pantalla completa para el personal. Contaminación cruzada, gravedad, gracias." },
...
const it: Translations = {
  ...
  hero: {
    ...
    subtitle: "Strumenti di viaggio IA per persone con malattia celiaca e intolleranza al glutine. Carte di traduzione, ristoranti sicuri, guide per paese — in tasca.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Modalità viaggio", text: "Un tap → carta a schermo intero per il personale. Contaminazione crociata, gravità, grazie." },
...
const pt: Translations = {
  ...
  hero: {
    ...
    subtitle: "Ferramentas de viagem com IA para pessoas com doença celíaca e intolerância ao glúten. Cartões de tradução, restaurantes seguros, guias por país — no seu bolso.",
  ...
  features: {
    ...
    items: [
      ...
      { title: "Modo viagem", text: "Um toque → cartão em ecrã inteiro para o pessoal. Contaminação cruzada, gravidade, obrigado." },
...
const ja: Translations = {
  ...
  hero: {
    ...
    titleLine2: "、ストレスなしで。",
    subtitle: "セリアック病とグルテン不耐性を持つ人々のためのAI旅行ツール。翻訳カード、安全なレストラン、国別ガイド — ポケットの中に。",
    ctaPrimary: "安全に旅を始める",
  ...
  features: {
    ...
    items: [
      ...
      { title: "トラベルモード", text: "ワンタップ → スタッフへのフルスクリーンカード。交差汚染、重症度、ありがとう。" },
